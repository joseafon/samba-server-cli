...
echo
echo "\e[93mCHOOSE A OPTION\e[0m"
...
\e[0m"
                                ...
                                echo
				                    ...
				                    sleep 2
				                        ...
				                        mkdir -p /etc/media/samba/public/"$directory"
				                        chmod 777 /etc/media/samba/public/"$directory"

				                        echo "
["$directory"]
path = /etc/media/samba/public/"$directory"
...
" >> /etc/samba/smb.conf
                                        ...
                                        touch /etc/samba/resources/"$directory".conf
...
create mode 0777
directory mode = 0777
" >> /etc/samba/resources/"$directory".conf
...
\e[0m"
		                ...
		                then
			                echo
                                # Delete public folder
				                rm -r /etc/media/samba/public/"$directory"
                                ...
                                rm /etc/samba/resources/"$directory".conf
                               ...
                               # Replaces the name of the WORKING GROUP that comes by default with the one previously used, saved in the workgroup variable
                                ...
                                cat /etc/samba/resources/*.conf >> /etc/samba/smb.conf 2>&1
...
\e[0m"
                            ...
                            echo
                                ...
                                ls /etc/media/samba/private 1>&2
			                ...
			                then
                                ...
                                then
				                    ...
				                    mkdir -p /etc/media/samba/private/$directory

				                    chgrp $directory /etc/media/samba/private/$directory

				                    chmod 770 /etc/media/samba/private/$directory

                                    # Create a file where the user save his groups
                                    touch /etc/samba/group/$directory

				                    echo "
[$directory]
path = /etc/media/samba/private/$directory
comment = $comment
browseable = yes
guest ok = no
writable = yes
...
create mode = 0770
directory mode = 0770
write list = @$directory" >> /etc/samba/resources/$directory.conf
...
\e[0m"
			                    ...
			                    then
				                    ...
				                    rm -r /etc/media/samba/private/$directory
                                   ...
                                   # Clear the share record
                                    ...
                                    rm -r /etc/samba/group/$directory
...
\e[0m"
                                ...
                                if [ -f /etc/samba/group/$directory ]
                                then
                                    clear
					                     ...
					                     read directory
						                    ...
						                    then
                                                ...
                                                then
                                                    ...
                                                    echo "$user" >> /etc/samba/group/$directory
...
\e[0m"
						        ...
						        then
							         ...
							         then
                                         ...
                                         grep -w $user /etc/samba/group/$directory > /dev/null 2>&1
                                         ...
                                         then
                                            ...
                                            line=$(sed -n '/'$user'/=' /etc/samba/group/$directory)

                                            # Delete the line where the value of the $line variable is located
                                            sed -i ''$line'd' /etc/samba/group/$directory
