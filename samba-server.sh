...
echo
	...
	then
        ...
        mkdir -p $HOME/samba/private $HOME/samba/public
...
\e[0m"
                                ...
                                echo
			                        ...
			                        if [ -d $HOME/samba/public/"$directory" ]
			                        then
                                    echo
				                    ...
				                    sleep 2
				                        ...
				                        mkdir -p $HOME/samba/public/"$directory"
				                        chmod 777 $HOME/samba/public/"$directory"

				                        echo "
["$directory"]
path = $HOME/samba/public/"$directory"
...
\e[0m"
		                ...
		                then
			                echo
                                # Delete public folder
				                rm -r $HOME/samba/public/"$directory"
...
\e[0m"
			                ...
			                if [ -d $HOME/samba/private/"$directory" ]
			                then
				                echo
                                ...
                                then
				                    ...
				                    mkdir -p $HOME/samba/private/$directory

				                    chgrp $directory $HOME/samba/private/$directory

				                    chmod 770 $HOME/samba/private/$directory

                                    # Create a file where the user save his groups
                                    touch /etc/samba/users/$directory

				                    echo "
[$directory]
path = $HOME/samba/private/$directory
comment = $comment
browseable = yes
guest ok = no
writable = yes
...
\e[0m"
			                    ...
			                    then
				                    ...
				                    rm -r $HOME/samba/private/$directory
                                   ...
                                   # Clear the share record
                                    ...
                                    rm -r /etc/samba/users/$directory
...
\e[0m"
                                ...
                                if [ -f /etc/samba/users/$directory ]
                                then
                                    clear
                                    ...
                                    echo "\e[96m---------------------------------------------------------\e[0m"
                                    echo
                                        less /etc/samba/users/$directory
					                     ...
					                     read directory
						                    ...
						                    then
                                                ...
                                                then
                                                    ...
                                                    echo "$user" >> /etc/samba/users/$directory
...
\e[0m"
						        ...
						        then
							         ...
							         then
                                         ...
                                         grep -w $user /etc/samba/users/$directory > /dev/null 2>&1
                                         ...
                                         then
                                            ...
                                            line=$(sed -n '/'$user'/=' /etc/samba/users/$directory)

                                            # Delete the line where the value of the $line variable is located
                                            sed -i ''$line'd' /etc/samba/users/$directory
